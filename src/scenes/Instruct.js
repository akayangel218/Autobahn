...
class Instruct extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width / 2, game.config.height / 3.8, 'has been reported to have been seen on a motorway.', menuConfig).setOrigin(0.5);
        ...
        this.add.text(game.config.width / 2, game.config.height / 2, 'Use all the arrow keys to move through traffic,', menuConfig).setOrigin(0.5);
